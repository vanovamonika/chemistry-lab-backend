  ...
  try {
    ...
    const reactions = [
      ...
      },
      {
        ...
        isVerified: true,
        isPublic: true,
        visualDescription: 'Combustion - flame and heat release',
      },
      {
        ...
        visualDescription: 'Ester formed, water byproduct',
        isVerified: true,
        isPublic: true,
      },
      {
        ...
        bubbles: true,
        visualDescription: 'CO2 gas evolves (bubbling)',
        isVerified: true,
        isPublic: true,
      },
      {
        equation: 'Pb(NO3)2 + 2 KI → PbI2 + 2 KNO3',
        ...
        precipitate: true,
        color: '#FFD700',
        visualDescription: 'Yellow precipitate of PbI2 forms',
        isVerified: true,
        isPublic: true,
      },
      {
        ...
        bubbles: true,
        visualDescription: 'Oxygen gas released (bubbling)',
        isVerified: true,
        isPublic: true,
      },
      {
        ...
        visualDescription: 'Copper metal plates out',
        isVerified: true,
        isPublic: true,
      },
    ];
